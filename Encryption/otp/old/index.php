                        ...
                        <form ; onkeyup="otpFunction('decrypt')">
                            ...
                            <center>
                                <label><b> Text Format:</b><label>
                                        <input type="radio" name="option_de" ; value="b64" ; id="b64" ;
                                            onclick="otpFunction('decrypt')" ; checked> <label for="b64">Base64</label>
                                        <input type="radio" ; name="option_de" ; value="hex" ; id="hex" ;
    ...
    <div>
            <center>
                <div class="container-tt">
                    <button class="open-container-button_tt" ; id="open-container-button_tt" ;>De/Encryption Process Visualization</button>
                </div>
            </center>
        </div>
        <br>
