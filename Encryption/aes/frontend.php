...
<body>
  ...
  <section class="container" name="about">
    <h1 style="font-size: 35px">ADVANCED ENCRYPTION STANDARD (AES)</h1>
    Cryptography | Symmetric Key Encryption Cipher
    <h2><u>What is AES?</u></h2>
    <p style="font-size:18px">The Advanced Encryption Standard (AES) algorithm, also referred to as the Rijndael
      algorithm, is a symmetrical block
      cipher algorithms that transform a block of 128 bits message into a 128 bits of
      ciphertext using either 128, 192 or 256 bit keys, making it a strong, secure and exponentially stronger algorithm.
      <br>
      The AES algorithm use a substitution-permutation, or SP network, with several rounds to generate ciphertext, the
      number of rounds will be determined by the key length used.
    </p>
    <p style="font-size:18px"> In each case, all the rounds are identical except for the last round where it would not
  ...
  <section class="container" ; name="hist">
    ...
    <p style="font-size:18px">With the gold standard then, Data Encryption Standard (DES), becoming much vulnerable
      and
      outdated as time passed, it increasingly vulnerable to brute-force attacks and the National Institute of
      Standards
      & Technology (NIST) required a newer and more secure gold standard. Thus, NIST announced a competition for the
      successor to DES and made it open to public, and the
      encryption algorithm was available to access worldwide. NIST selected the Rijndael algorithm of Belgian
      cryptographers Joan Daemen and Vincent Rijmen as the winner in October 2000, over the progression of three
      competitive rounds and fierce cryptanalysis by the world's leading encryption specialists. Due to it perfect
  ...
  <section class="container" ; name="app">
    ...
    <ul>
      ...
      To determine the number of rounds, number of transformation cycles that the algorithm goes through in order to
      encrypt the data.
      <br>
      ...
      Determines how the plaintext is transformed into ciphertext during the encryption process of AES. Each cipher type
      has
      its own specific strengths and weaknesses in terms of security, speed, and error propagation. Therefore, the
      choice of
      ...
      <Ul>
        ...
        <b> Weakness: </b>Not secure in most cases, as repeating patterns in the plaintext will result in repeating
        patterns in
        the ciphertext.
        <br>
        <br>
        ...
        <br><b>Weakness:</b> Requires a unique Initialization Vector (IV) for each encryption, which must be transmitted
        with the
        ...
        <br>
        <li>CTR (Counter):</li>
        <b>Strength:</b> Parallelizable, meaning it can encrypt multiple blocks of data at the same time.
        ...
        <b>Weakness:</b> Requires a unique Initialization Vector (IV) for each encryption, which must be transmitted
        with the
        ciphertext to the decryption process.<br>
      </Ul>
      <br>
      <li style="font-size:20px">Initialization Vector (IV)</li>
      An IV of 128 bits is generated and used in the encryption process to add randomness and avoid repetition.
      <br><br>
      <li style="font-size:20px">Passphrase</li>
      Used to generate a key for the encryption process. The passphrase would be converted into a secure
      encryption key via key derivation function, such as PBKDF2 (commonly used in OpenSSL). The passphrase can be any
      combination of
      characters, such as a phrase or sequence of words. It is used to ensure the confidentiality and security of
      the encrypted data. The strength of the encryption depends on the length, complexity and randomness of the
      passphrase.
    </ul>
    ...
    <ol>
      ...
      A key of 128, 192, or 256 bits is generated to be used in the encryption process. This key is
      ...
      <br>
      <li> Main Rounds</li>
      The encryption process consists of 10, 12, or 14 rounds of transformations (depending on the key
      size).
      ...
      <li> Decryption</li> The decryption process is simply the reverse of the encryption process. The ciphertext is
      XORed with the round keys in reverse order to obtain the original plaintext.
    </ol>
    <br>
    <p style="font-size:20px">The AES encryption algorithm is considered to be highly secure and is widely used in a
  ...
  <section class="container" ; name="com">
    ...
    <table>
      ...
      <tr>
        <td>
          About 2<sup>128</sup> attempts are needed to break every 128 bits, making it highly secure and almost
          impossible to hack
        </td>
        <td>
      ...
      <tr>
        <td>
          it is more robust against hacking due to the usage of higher length key sizes such as 128, 192 and 256
          bits
          for encryption
        </td>
        <td>
          AES in Galois/Counter mode may affect performance and security due to it's complexity when implementing in
  ...
  <section class="container" ; name="test">
    ...
    <br>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/nC0mjaUZd8w" title="YouTube video player"
      frameborder="0"
