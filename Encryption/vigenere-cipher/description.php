...
<main>
  <div class="faq-heading">
    ...
    <p style="font-size:18px">Vigenère cipher is a method of encryption uses a simple substitution to encode a
            ...
            cipher. The Vigenère cipher uses a keyword to generate a series of alphabets, with each alphabet shifted by
            a
      ...
      <div class="faq-two">
        ...
        <div class="faq-body">
          <p style="font-size:18px">Although the Vigenère cipher was first described by Blaise de Vigenère in the
            ...
            described it in a book published in 1553. The cipher was later misattributed to Vigenère, leading to it
            being
            ...
            unbreakable for a long time. However, in the 19th century, Charles Babbage and Friedrich Kasiski
            independently
            discovered methods for breaking the cipher, making it possible to decode messages encrypted using the
            Vigenère
            cipher. Despite it, the Vigenère cipher continued to be widely used and was still in use during World War I
            and World War II.
            <br>
            Today, the Vigenère cipher is considered to be relatively weak and is not used for secure communications.
            However,
      ...
      <div class="faq-three">
        ...
        <div class="faq-body">
          ...
          <div
            ...
            <br>
            <br>
            <p style="font-size:20px"> &nbsp;For generating key, the given keyword is repeated
        ...
        <div class="faq-body">
          <Table>
            ...
            <tr>
              ...
              <td>
                Vulnerable to frequency analysis, a method to break a cipher by analyzing the frequency of letters in
                the
                ciphertext.
              </td>
            </tr>
            <tr>
              ...
              <td>
                The length of the keyword used in the Vigenère cipher is limited, it can be easily broken if the key is
                too
                short.
              </td>
            </tr>
            <tr>
              ...
              <td>
                Not secure enough for modern use, as more advanced cipher methods have been developed that provide
                stronger
                security.
              </td>
            </tr>
          </Table>
          <p style="font-size:18px">Overall, while the Vigenère cipher has some advantages, it is not considered secure
            enough
